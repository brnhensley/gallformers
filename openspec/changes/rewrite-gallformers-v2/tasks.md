...
- [ ] 0.2 Create `fix-security-critical` sub-proposal
- [ ] 0.3 Create `add-go-api` sub-proposal
- [ ] 0.4 Create `add-svelte-admin` sub-proposal
- [ ] 0.5 Create `add-svelte-public` sub-proposal
- [ ] 0.6 Create `cutover-v2` sub-proposal

## 1. Phase 0: Security Fixes (Immediate)

- [ ] 1.1 Complete `fix-security-critical` proposal implementation
...
- [ ] 1.2 Deploy security fixes to production
...
- [ ] 2.1 Complete `add-go-api` proposal implementation
  ...
  - Build mutation endpoints with audit logging
