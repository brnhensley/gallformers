...
<div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
	...
	<section class="mb-10">
		...
		<div class="bg-white rounded-lg shadow-md divide-y">
			<div class="p-4">
				<a href="/id" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					Gallformers ID Tool
				</a>
			...
			<div class="p-4">
				<a href="https://megachile.shinyapps.io/doycalc/" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					Gall Phenology Tool
				</a>
				<p class="text-gray-600 text-sm mt-1">
	...
	<section class="mb-10">
		...
		<div class="bg-white rounded-lg shadow-md divide-y">
			<div class="p-4">
				<a href="https://www.inaturalist.org" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					iNaturalist
				</a>
				<p class="text-gray-600 text-sm mt-1">
			...
			<div class="p-4">
				<a href="https://bugguide.net" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					BugGuide
				</a>
				<p class="text-gray-600 text-sm mt-1">
			...
			<div class="p-4">
				<a href="https://www.biodiversitylibrary.org" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
			...
			<div class="p-4">
				<a href="https://scholar.google.com" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					Google Scholar
				</a>
				<p class="text-gray-600 text-sm mt-1">
	...
	<section class="mb-10">
		...
		<div class="bg-white rounded-lg shadow-md divide-y">
			<div class="p-4">
				<a href="/glossary" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
			...
			<div class="p-4">
				<a href="/filterguide" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					Filter Guide
				</a>
				<p class="text-gray-600 text-sm mt-1">
			...
			<div class="p-4">
				<a href="/refindex" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					Reference Articles
				</a>
				<p class="text-gray-600 text-sm mt-1">
	...
	<section class="mb-10">
		...
		<div class="bg-white rounded-lg shadow-md divide-y">
			<div class="p-4">
				<a href="https://www.inaturalist.org/projects/galls-of-north-america" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
			...
			<div class="p-4">
				<a href="https://twitter.com/gallformers" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
			...
			<div class="p-4">
				<a href="https://www.patreon.com/gallformers" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
					Gallformers Patreon
				</a>
				<p class="text-gray-600 text-sm mt-1">
	...
	<section class="mb-10">
		...
		<div class="bg-white rounded-lg shadow-md divide-y">
			<div class="p-4">
				<a href="https://github.com/jeffdc/gallformers" target="_blank" rel="noreferrer" class="text-gf-maroon hover:text-gf-maroon-dark font-medium">
